...
@loader.tds
class SCIENSEBackupMod(loader.Module):
    """Handles database and modules backups"""

    strings = {"name": "SCIENSEBackup"}
    ...
    async def client_ready(self):
        ...
        self._backup_channel, _ = await utils.asset_channel(
            ...
            silent=True,
            archive=True,
            avatar="https://i.pinimg.com/736x/11/5c/65/115c6576c9d51dd10a35d454804af784.jpg",
            _folder="SCIENSE",
            invite_bot=True,
        )
    ...
    async def handler(self):
        try:
            ...
            backup.name = (
                f"SCIENSE-db-backup-{datetime.datetime.now():%d-%m-%Y-%H-%M}.json"
            )
            ...
            logger.exception("SCIENSEBackup failed")
