...
class UserInfoMod(loader.Module):
    """Получение информации о пользователе или канале Telegram, включая дату регистрации и данные из @Python_Javs"""
    ...
    async def doxscmd(self, message: Message):
        """Получить информацию о пользователе или канале. Использование: .doxs <@юзернейм/ID> или ответ на сообщение"""
    ...
    async def process_user_info(self, user_ent, message):
        ...
        user_info += f"<b>🍓 Информация из dox:</b>\n{funstat_info}"
